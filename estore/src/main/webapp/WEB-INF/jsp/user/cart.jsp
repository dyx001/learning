...
<!--文件体开始-->
		...
		<tr>
			...
			<tr>
				...
				<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="/book/id/${entry.value.book.id }">${entry.value.book.name }</a></td>
				...
				<input type="button" value="删除" onclick="javascript:window.location='/cart/delete/${entry.value.book.id}';"> 
		...
		<tr>
			...
			<input type="button" value="确认订单" onclick="javascript:window.location='/order/confirm';"> 
			<input type="button" value="继续购物" onclick="javascript:window.location='/index';"> 
			<input type="button" value="清空购物车" onclick="javascript:window.location='/cart/clear';"></td>
		</tr>
                </table><br>
<!--文件尾开始-->
