...
<!--文件体开始-->
		...
		<tr>
			...
			<tr>
				...
				<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="/order/id/${order.id }">${order.id }</a></td>
				...
				<input type="button" value="删除" onclick="javascript:window.location='/order/delete/${order.id}';">&nbsp;
				<input type="button" value="明细" onclick="javascript:window.location='/order/id/${order.id }';">
				</td>
			</tr>
