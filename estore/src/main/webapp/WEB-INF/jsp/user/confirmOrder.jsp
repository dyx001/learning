...
<!--文件体开始-->
		...
		<form name="order" method="post" action="/order/submit">
		<table cellpadding="3" cellspacing="1" align="center" class="tableborder1" id="table1">
		<tr>
			<td valign="middle" colspan="2" align="center" height="25" background="images/bg2.gif">
			<font color="#ffffff"><b>用户信息</b></font><input type="button" value="修改" onclick="javascript:window.location='/customer';"></td>
		</tr>
		<tr>
...
<!--文件尾开始-->
		...
		<tr>
			...
			<font color="#ffffff"><b>商品购物清单</b></font><input type="button" value="修改" onclick="javascript:window.location='/cart';"></td>
		</tr>
        
       
			<tr>
				<td class=tablebody2 valign=middle align=center width="">${entry.value.book.id }</td>
				<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="/book/id/${entry.value.book.id }" target="_blank">${entry.value.book.name }</a></td>
